...
SRD_LOOT: dict[str, list[dict[str, str]]] = {
    ...
    "armor": [
        {"name": "Padded Armor", "desc": "Quilted layers. AC 11 + Dex, stealth disadvantage."},
        {"name": "Leather Armor", "desc": "Cured hide. AC 11 + Dex."},
        {"name": "Studded Leather", "desc": "Reinforced leather. AC 12 + Dex."},
        {"name": "Hide Armor", "desc": "Thick animal pelts. AC 12 + Dex (max 2)."},
        {"name": "Chain Shirt", "desc": "Interlocking rings. AC 13 + Dex (max 2)."},
        {"name": "Scale Mail", "desc": "Overlapping plates. AC 14 + Dex (max 2), stealth disadv."},
        {"name": "Breastplate", "desc": "Fitted metal chest piece. AC 14 + Dex (max 2)."},
        {"name": "Half Plate", "desc": "Shaped plates and mail. AC 15 + Dex (max 2), stealth disadv."},
        {"name": "Ring Mail", "desc": "Leather with heavy rings. AC 14, stealth disadvantage."},
        {"name": "Chain Mail", "desc": "Full chain links. AC 16, Str 13, stealth disadvantage."},
        {"name": "Splint Armor", "desc": "Vertical metal strips. AC 17, Str 15, stealth disadv."},
        {"name": "Plate Armor", "desc": "Full plate harness. AC 18, Str 15, stealth disadvantage."},
        {"name": "Shield", "desc": "A wooden or metal shield. +2 AC."},
    ],
    "potions": [
